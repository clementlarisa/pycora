"""pycora — minimal Python port of CORA reachability for autonomous driving.
...
Implements:
  ...
  - Kinematic single-track (KS) bicycle model (vehicleDynamics_KS_cog)

Uses JAX for analytical Jacobians and Hessians (matches CORA's symbolic-
derivative fidelity).

Reference: M. Althoff, "Reachability analysis and its application to the
safety assessment of autonomous cars", PhD dissertation, TU München, 2010.
"""
